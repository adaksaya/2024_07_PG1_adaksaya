...
For example, the input 1156 represents 11 dollars and 56 cents.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Your amount " + numbOfOneDollars + " dollars, " + numbOfQuarterCents + " quartercents, " + numbOfDimeCents + " dimecents, " + numbOfNickelCents + " nickelcents, and " + numbOfPennies + " cents");
